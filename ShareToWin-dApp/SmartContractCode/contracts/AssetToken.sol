...
contract AssetToken is ERC721Enumerable,Ownable{
    ...
    //that is associated. Will this generate new contract code.  
    function registerAsset(uint256 assetID,uint256 salePrice,string calldata _uri) public returns(uint256 newTokenID) {
        ...
        //emit AssetRegistered(msg.sender,assetID,newTokenID);
    ...
    //event AssetRegistered(address indexed registrant,uint256 indexed assetid, uint256 indexed tokenId);
